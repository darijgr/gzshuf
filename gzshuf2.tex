...
%TCIDATA{LastRevised=Sunday, October 08, 2017 22:51:17}
...
\begin{example}
\label{exa.ambivPp.abc}\textbf{(a)} If $\mathcal{N}=\mathbb{P}$ and
$\mathcal{Z}=\mathcal{N}\times\left\{  +\right\}  =\left\{  +n\ \mid
\ n\in\mathcal{N}\right\}  $, then the $\mathcal{Z}$-enriched $\left(
