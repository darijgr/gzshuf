...
%TCIDATA{LastRevised=Saturday, September 30, 2017 09:05:56}
...
definition of an $\mathcal{Z}$-enriched $\left(  \left[  n\right]
,\pi\right)  $-partition. Let me spell it out: Let $f\in\mathcal{E}\left(
\left[  n\right]  ,\pi\right)  $. Thus, $f$ is an $\mathcal{Z}$-enriched
