...
%TCIDATA{LastRevised=Saturday, September 30, 2017 13:57:05}
...
follows:
\[
\left[  n\right]  \setminus\Lambda=\left[  1,u_{1}-1\right]  \cup\left[
u_{1}+1,u_{2}-1\right]  \cup\left[  u_{2}+1,u_{3}-1\right]  \cup\cdots
\cup\left[  u_{\ell-1}+1,u_{\ell}-1\right]  \cup\left[  u_{\ell}+1,n\right]  .
\]
...
u_{1}+1,u_{2}-1\right]  ,\left[  u_{2}+1,u_{3}-1\right]  ,\ldots,\left[
u_{\ell-1}+1,u_{\ell}-1\right]  ,\left[  u_{\ell}+1,n\right]  $, the map $\pi$
