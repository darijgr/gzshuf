...
whose restriction to $\left[  n\right]  $ is $\pi$ and whose restriction
to $\left[ m \right]$ is $\sigma$. This map $\varepsilon$ is injective,
since $\pi$ and $\sigma$ are disjoint permutations.
Thus, $\left( \left[ n \right] \sqcup \left[ m \right] , \varepsilon\right)$
is a labeled poset.
