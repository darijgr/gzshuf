...
%TCIDATA{LastRevised=Tuesday, May 15, 2018 01:06:42}
...
Next, we can define a notion similar to shuffle-compatibility:
...
\tau\right)  \ \mid\ \tau\in S_{\succ}\left(  \pi^{\prime},\sigma^{\prime
}\right)  \right\}  .
\end{align*}
...
$\pi^{\prime}=\left(  3,1\right)  $ and $a^{\prime}=2$, then we do have%
\[
...
this section, we shall analyze it for three further statistics.
