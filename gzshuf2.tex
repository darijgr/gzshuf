...
Now, assume (for the sake of contradiction) that $\pi_{i-1}\leq\pi_{i}$. But
...
b\text{)}}}\cap\operatorname*{Epk}\pi=\underbrace{\left\{  a,a+1,\ldots
,b\right\}  }_{=S}\cap\operatorname*{Epk}\pi\\
&  =S\cap\operatorname*{Epk}\pi=\left\{  a,b\right\}  .
\end{align*}
...
Now, assume (for the sake of contradiction) that $\pi_{j}\geq\pi_{j+1}$. But
...
b\text{)}}}\cap\operatorname*{Epk}\pi=\underbrace{\left\{  a,a+1,\ldots
,b\right\}  }_{=S}\cap\operatorname*{Epk}\pi\\
&  =S\cap\operatorname*{Epk}\pi=\left\{  b\right\}  .
\end{align*}
In other words, $z=b$.
...
}n=b\text{)}}}\cap\operatorname*{Epk}\pi=\underbrace{\left\{  a,a+1,\ldots
,b\right\}  }_{=S}\cap\operatorname*{Epk}\pi\\
&  =S\cap\operatorname*{Epk}\pi=\left\{  a\right\}  .
\end{align*}
In other words, $z=a$.
...
1,2,3,\ldots\right\}  $. Hence, Lemma \ref{lem.fiberends.cut} \textbf{(b)}
(applied to $u=h$) yields $\operatorname*{FE}\left(  g\right)  \cap
...
\operatorname*{FE}\left(  g\right)  }\subseteq g^{-1}\left(  h\right)
\cap\operatorname*{FE}\left(  g\right)  =\operatorname*{FE}\left(  g\right)
\cap g^{-1}\left(  h\right)  =\left\{  \min\left(  g^{-1}\left(  h\right)
