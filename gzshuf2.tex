...
%TCIDATA{LastRevised=Monday, February 19, 2018 10:17:03}
...
$\operatorname*{QSym}$ is the trivial ideal, and is a $\tvi$-ideal, a
...
proven in \cite[Theorem 4.5 \textbf{(a)}]{part1} that this statistic
...
$\operatorname*{QSym}$ is a left $\tvi$-ideal and a left $\bel$-ideal, but
...
=\operatorname*{maj}A+\operatorname*{maj}B+n\cdot\operatorname*{des}A$.
\end{lemma}
...
_{\operatorname*{maj}}$ is a left $\tvi$-ideal of $\operatorname*{QSym}$, we
...
_{\operatorname*{maj}}$ is a left $\bel$-ideal of $\operatorname*{QSym}$.
