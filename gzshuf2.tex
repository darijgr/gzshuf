...
\end{align*}
But $z\in\left\{  i,i+1,\ldots,p-1\right\}  \cap\operatorname{Epk}%
\pi\subseteq\left\{  i,i+1,\ldots,p-1\right\}  $, so that $z\leq p-1<p\leq b$.
...
\subseteq \left\{  a,b\right\}  .
\end{align*}
But $z\in\left\{  p+1,p+2,\ldots,j\right\}  \cap\operatorname{Epk}%
\pi\subseteq\left\{  p+1,p+2,\ldots,j\right\}  $, so that $z\geq p+1>p\geq a$.
...
\mathcal{N}\text{ is}\\\text{weakly increasing;}\\\operatorname{Epk}%
\pi\subseteq\operatorname*{FE}\left(  g\right)  }}
\]
...
and thus are order-isomorphic. Hence, $\operatorname{st}\left(
