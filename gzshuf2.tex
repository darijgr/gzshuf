...
thus, a labelled poset needs no labelling, but instead its underlying
set must be a finite set of integers.
...
A minimum element of a poset $P$ is unique if it exists; it is denoted by
$\min P$.
...
Note that we are using the notation $\min P$ for the minimum element
