...
%TCIDATA{LastRevised=Monday, May 28, 2018 11:01:19}
...
show that $\operatorname*{Epk}$ is LR-shuffle-compatible.
...
\end{align}
This proves (\ref{pf.thm.head-comp.LRcomp.c1.eq4}). It remains to prove (\ref{pf.thm.head-comp.LRcomp.c1.eq3}).
...
\]
Here, if $\gamma$ is any composition, then $\ell\left(\gamma\right)$ denotes
the \textit{length} of $\gamma$ (that is, the number of entries of $\gamma$).
\end{proposition}
