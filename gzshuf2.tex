...
-0\right\}  $; this definition is equivalent to an appropriately corrected
version of \cite[Definition 4.1]{Peters05} (note, however, that
\cite{Peters05} assumes that the ground set of $P$ is already a subset
of $\mathbb{P}$, and that the labelling $\gamma$ is the
canonical inclusion map $ P \to \mathbb{P}$).}:
