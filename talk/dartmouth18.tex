...
\item \textbf{Product formula.} If $\pi$ is an $n$-permutation and $\sigma$
      is an $m$-permutation such that $\pi$ and $\sigma$ are disjoint, then
        \[
...
\pause
\item Similarly, \textbf{Theorem:} A descent statistic $\st$ is
...
\item \textbf{Question.}
      What do the kernels $\mathcal{K}_{\st}$ look like for
      $\st = \Pk, \Lpk, \ldots$?
...
\item A permutation statistic $\st$ is said to be
      ...
      \[
      \pi = \tup{\pi_1, \pi_2, \ldots, \pi_n} \qquad \Longrightarrow \qquad
      \pi : a = \tup{\pi_1, \pi_2, \ldots, \pi_n, a} .
      \]
