...
%TCIDATA{LastRevised=Tuesday, March 27, 2018 20:42:03}
...
peaks, so that $\pi$ would be either strictly increasing or strictly
decreasing; but then, either $n$ or $1$ would be an exterior peak of $\pi$,
which would contradict the emptiness of $\operatorname*{Epk}\pi$.]
\end{verlong}
...
shuffle-compatible. Theorem~\ref{thm.4.3} \textbf{(b)} then yields that the
$\mathbb{Q}$-linear map%
\[
...
\bibitem[GesZhu17]{part1}\href{http://arxiv.org/abs/1706.00750v2}{Ira M.
